...
svgEditor.addExtension("sozi_mode", function(obj) {
	...
	$.getScript('extensions/sozi/sanitize.js');
	$.getScript('extensions/sozi/webtoolkit.base64.js');
	...
	function execSoziSave() {
		...
		if(svgedit.browser.isChrome()) { //Since we will declare FF + Chrome support, no need Safari detection
			...
			$.alert('<a href="data:image/svg+xml;base64,'+Base64.encode(xmlStr)+'" target="_blank">Salvar</a>');
			return;
